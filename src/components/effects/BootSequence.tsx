  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'repeating-linear-gradient(0deg, transparent, transparent 1px, rgba(0,245,255,0.015) 1px, rgba(0,245,255,0.015) 2px)',
        }}
      />
      ...
      <div className="max-w-lg w-full px-8">
        ...
        <div className="mb-6 flex items-center gap-3">
          <div className="flex gap-0.5">
            <div className="w-1.5 h-1.5 bg-[#00F5FF]" />
            <div className="w-1.5 h-1.5 bg-[#00F5FF]" />
            <div className="w-1.5 h-1.5 bg-[#00F5FF]" />
          </div>
          <span className="font-mono text-[10px] text-[#00F5FF]/40 uppercase tracking-widest">
            Pixfork Games OS
          </span>
        </div>
        ...
        <div className="mt-6 h-0.5 bg-[#1A1A2E] rounded-sm overflow-hidden">
          <div
            className="h-full bg-[#00F5FF] transition-all duration-200"
